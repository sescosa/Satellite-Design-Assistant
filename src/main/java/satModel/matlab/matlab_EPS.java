...
public class matlab_EPS{
	...
	public double[] designEPS(HashMap<String,Double> inputList, String[] symbVar, String matlabFile, String[] outputVars) 
	{
		try{
		...
		proxy.eval("addpath('C:\\TFG\\tfg_spring\\src\\main\\java\\satModel\\power\\clp')");
