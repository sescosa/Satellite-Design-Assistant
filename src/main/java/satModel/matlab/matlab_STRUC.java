...
public class matlab_STRUC{
	...
	public double[] designSTRUC(HashMap<String,Double> inputList, String[] symbVar, String matlabFile, String[] outputVars) 
	{
		try{
		...
		proxy.eval("addpath('C:\\TFG\\tfg_spring\\src\\main\\java\\satModel\\structure\\clp')");
	    ...
	    for (int i = 0; i < outputVars.length; i++){
    		...
    		//System.out.println(outputVars[i] + " outputs: " + result[i]);
	    }
