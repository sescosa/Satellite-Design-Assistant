...
public class matlab_TTC{
	...
	public double[] designTTC(HashMap<String,Double> inputList, String[] symbVar, String matlabFile, String[] outputVars) 
	{
		try{
		...
		proxy.eval("addpath('C:\\TFG\\tfg_spring\\src\\main\\java\\satModel\\comms\\clp')");
